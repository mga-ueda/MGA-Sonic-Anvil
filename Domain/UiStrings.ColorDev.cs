...
internal static partial class UiStrings
{
    ...
    public static string ColorDevGroupLoudness => Get("ラウドネス", "Loudness");
    ...
    public static string ColorLabel(string key)
    {
        ...
        return token switch
        {
            ...
            "SpectrogramSelectionFill" => Get("スペクトログラム選択", "Spectrogram selection"),
            "SpectrogramGrid" => Get("スペクトログラム罫線", "Spectrogram grid"),
            "SpectrogramScaleEdge" => Get("周波数目盛の縁", "Frequency scale edge"),
            "SpectrogramBoostFloor" => Get("ブーストバー・下", "Boost bar · floor"),
            "SpectrogramBoostMid" => Get("ブーストバー・中", "Boost bar · mid"),
            "SpectrogramBoostCeil" => Get("ブーストバー・上", "Boost bar · ceiling"),
            "SpectrogramBoostThumbFill" => Get("ブーストつまみ", "Boost thumb"),
            "SpectrogramBoostThumbStroke" => Get("ブーストつまみ枠", "Boost thumb · border"),
            "SpectrogramBoostThumbHoverFill" => Get("ブーストつまみ・ホバー", "Boost thumb · hover"),
            "SpectrogramBoostThumbHoverStroke" => Get("ブーストつまみ枠・ホバー", "Boost thumb border · hover"),
            "LoudnessSafe" => Get("安全", "Safe"),
            "LoudnessCaution" => Get("注意", "Caution"),
            "LoudnessDanger" => Get("超過", "Over"),
            "LoudnessWaveFill" => Get("波形", "Waveform"),
            "LoudnessChipFore" => Get("チップ文字", "Chip text"),
            "LoudnessGrid" => Get("罫線", "Grid"),
            "LoudnessTargetLine" => Get("ターゲット線", "Target line"),
            ...
            "PlayerPlaceholderJacketTop" => Get("ジャケットなし・上", "No jacket · top"),
            ...
            "PlayerHoverFill" => Get("ホバー", "Hover"),
            "PlayerComboFill" => Get("コンボ・塗り", "Combo · fill"),
            "PlayerComboHoverFill" => Get("コンボ・ホバー塗り", "Combo · hover fill"),
            "PlayerComboDisabledFill" => Get("コンボ・無効塗り", "Combo · disabled fill"),
            ...
            "PlayerVectorScopeGrid" => Get("十字・罫線", "Cross · grid"),
            "PlayerSurroundHullStroke" => Get("サラウンド RMS 枠", "Surround RMS hull"),
            "PlayerWaapiToggleOffBack" => Get("WAAPI オフ・背景", "WAAPI off · background"),
            "PlayerWaapiToggleOffHoverBack" => Get("WAAPI オフ・ホバー", "WAAPI off · hover"),
            "PlayerWaapiToggleOnBack" => Get("WAAPI オン・背景", "WAAPI on · background"),
            "PlayerWaapiToggleOnHoverBack" => Get("WAAPI オン・ホバー", "WAAPI on · hover"),
            "PlayerJacketReflection" => Get("ジャケットの映り込み", "Jacket reflection"),
            "LevelMeterClipOff" => Get("クリップ消灯", "Clip off"),
            "LevelMeterClipOffBorder" => Get("クリップ消灯枠", "Clip off border"),
            "LevelMeterClipOn" => Get("クリップ点灯", "Clip on"),
            "LevelMeterClipOnOverlay" => Get("クリップ点灯の重ね", "Clip on · overlay"),
            ...
            "RecordLatchFore" => Get("録音ラッチ", "Record latch"),
